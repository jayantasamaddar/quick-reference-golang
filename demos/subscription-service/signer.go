...
func VerifyToken(token string) bool {
	...
	// Error: If signature is not valid. Token was tampered with, forged, or maybe it's
	// not even a token at all! Either way, it's not safe to use it. Return false
	// Else return true for valid hash
	return err == nil
}
